...
GuardarConexion("CREATE TABLE Usuario (id SERIAL PRIMARY KEY, Nombre VARCHAR(100), Apellido VARCHAR(200), Cedula INT, Edad INT, Telefono VARCHAR(10), Email VARCHAR(100), Password VARCHAR(50))")
GuardarConexion("CREATE TABLE FamiliarDesignado (id SERIAL PRIMARY KEY, usuario_id INT, Direccion VARCHAR(100), CONSTRAINT fkUsuarioFamiliar FOREIGN KEY (usuario_id) REFERENCES Usuario(id))")
