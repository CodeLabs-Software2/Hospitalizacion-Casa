...
GuardarConexion("CREATE TABLE PersonalACargo(id SERIAL PRIMARY KEY, medico_id INT, Paciente_id INT, Paciente_activo boolean, CONSTRAINT fkPersonalMedico FOREIGN KEY (medico_id) REFERENCES PersonalMedico(id), CONSTRAINT fkPacientePersonal FOREIGN KEY (paciente_id) REFERENCES Paciente(id) )")